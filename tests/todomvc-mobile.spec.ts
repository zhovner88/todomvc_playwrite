...
test.describe('TodoMVC Mobile - with Rotation', () => {
  test('Should add a single todo and survive rotation', async ({ page, webApp }) => {
  ...
  test('Should add multiple todos and survive rotation', async ({ page, webApp }) => {
  ...
  test('Should complete a todo and survive rotation', async ({ page, webApp }) => {
  ...
  test('Should edit a todo and survive rotation', async ({ page, webApp }) => {
    await test.step('Add todo', async () => {
  ...
  test('Should delete a todo and survive rotation', async ({ page, webApp }) => {
    await test.step('Add todo', async () => {
  ...
  test('Should filter todos and survive rotation', async ({ page, webApp }) => {
  ...
  test('Should handle long todo and survive rotation', async ({ page, webApp }) => {
  ...
  test('Should handle emoji todo and survive rotation', async ({ page, webApp }) => {
